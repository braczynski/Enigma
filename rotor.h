...
class rotor {
private:
    int notch_position_ = 0, notch_position_2_ = 0, rotor_position_ = 0, ring_position_ = 0;
...
public:
    ...
    rotor(int initial_position_rotor, int notch_position_on_rotor, int notch_position_on_rotor_2,  int initial_ring_position, std::vector<char> initial_combination);
